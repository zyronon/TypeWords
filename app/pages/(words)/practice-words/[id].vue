...
import type { Dict, PracticeData, TaskWords, Word } from '@/core/types/types.ts'
...
import { getCurrentStudyWord, useWordOptions } from '@/core/hooks/dict.ts'
...
import { BaseIcon, Toast, ToastComponent, Tooltip } from '@/base'
...
import ConflictNotice from '@/core/components/dialog/ConflictNotice.vue'
import PracticeLayout from '@/core/components/PracticeLayout.vue'
import { AppEnv, DICT_LIST, LIB_JS_URL, TourConfig, WordPracticeModeStageMap } from '@/core/config/env.ts'
...
import { flushStatToStore, usePracticeWordPersistence } from '@/core/composables/usePracticePersistence.ts'
import {
  IdentifyMethod,
  ShortcutKey,
  WordPracticeMode,
  WordPracticeStage,
  WordPracticeType,
} from '@/core/types/enum.ts'
import ConflictNotice2 from '@/core/components/dialog/ConflictNotice2.vue'
...
import CollectNotice from '@/core/components/dialog/CollectNotice.vue'
