...
import EditSingleArticleModal from '@/core/components/article/EditSingleArticleModal.vue'
import TypingArticle from '@/core/components/article/TypingArticle.vue'
